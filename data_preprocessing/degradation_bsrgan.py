...
def degradation_bsrgan(img, sf=4, isp_model=None):
    isp_prob, jpeg_prob, scale2_prob = 0.1, 0.0, 0.0
    sf_ori = sf
...
if __name__ == '__main__':
    # img = imread_uint(r'HAT/datasets/input_dir/1.jpg', 3)
    # img = uint2single(img)
    # sf = 4
    
    # for i in range(20):
    #     img_lq, img_hq = degradation_bsrgan(img, sf=sf)
    #     print(i)
